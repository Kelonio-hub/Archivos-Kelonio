...
def enviar_a_discord(productos):
    ...
    # Mensaje principal con el enlace a tu web
    payload = {
        "content": f"🔥 **¡Nuevos productos destacados del día en La Presa!** 🔥\n🌐 Visita nuestro catálogo completo aquí: {ENLACE_WEB}",
        "embeds": embeds
    }
    ...
    if respuesta.status_code in [200, 204]:
        ...
        # Ahora el script forzará un error visible en GitHub si Discord lo rechaza
